...
# FunÁ„o para calcular todas as estatÌsticas para uma coluna
...
# Aplicar a funÁ„o para cada coluna e armazenar os resultados em um dataframe
estatisticas <- sapply(dadosnome, calcular_estatisticas)

# Adicionar os nomes das linhas
rownames(estatisticas) <- c("MÈdia", "M·ximo", "Mediana", "Desvio Padr„o")
